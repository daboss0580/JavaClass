...
Result is ::: 5.0
     */
    void display1(double result);
}
class A177Tester{
    public static void main(String[] args) {
        A177Test test=new A177Test();
        System.out.println(test.adding(100.00,20.00));
        System.out.println(test.subtracting(100.00,20.00));
        System.out.println(test.multiply(100.00,20.00));
        System.out.println(test.dividing(100.00,20.00));
    }
