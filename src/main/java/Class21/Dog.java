...
class Horse extends Animal{
    ...
    void run(){
        System.out.println("Horses runs fast");
    }
...
*/
        ...
        for (Animal animals1:animals){
            ...
            Animal horseObjectStoredInAnAnimal =new Horse("Spirit", "brown", "Arabian Horse");
            Horse h=(Horse) horseObjectStoredInAnAnimal;
            h.run();
            ((Horse) horseObjectStoredInAnAnimal).run();
